    ...
    <div className="min-h-screen bg-[var(--surface)] py-12 px-4">
      <div className="mx-auto max-w-3xl">
        <div className="bg-[var(--surface-container)] rounded-2xl border border-[var(--outline-variant)] shadow-sm p-8 space-y-6">
          <h1 className="text-2xl font-bold text-[var(--on-surface)]">{t('datenschutz_title')}</h1>
          <p className="text-sm text-[var(--on-surface-variant)]">{t('stand')}: Mai 2026</p>

          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">1. Verantwortlicher</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">2. Erhobene Daten</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">3. Zweck der Verarbeitung</h2>
            <p className="text-[var(--on-surface-variant)] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">4. Speicherdauer</h2>
            <p className="text-[var(--on-surface-variant)] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">5. Datenübermittlung</h2>
            <p className="text-[var(--on-surface-variant)] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">6. Ihre Rechte</h2>
            <p className="text-[var(--on-surface-variant)] text-sm leading-relaxed mb-2">
              Sie haben folgende Rechte gemäß DSGVO:
            </p>
            <ul className="list-disc list-inside text-[var(--on-surface-variant)] text-sm space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--on-surface)] mb-2">7. Cookies</h2>
            <p className="text-[var(--on-surface-variant)] text-sm leading-relaxed">
